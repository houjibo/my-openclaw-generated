...
exports.nodejsIntents = void 0;
exports.registerNodeJSScenario = registerNodeJSScenario;
const types_1 = require("../types");
const fs = __importStar(require("fs/promises"));
const child_process_1 = require("child_process");
const util_1 = require("util");
const execAsync = (0, util_1.promisify)(child_process_1.exec);
exports.nodejsIntents = [
    {
        id: 'analyze_package',
...
function registerNodeJSScenario(registry) {
    registry.registerScenario('nodejs', exports.nodejsIntents);
...
//# sourceMappingURL=nodejs-scenario.js.map